...
su -c "echo 'ro.serialno=HUAHBXCRYR3JDKT7' >> /data/adb/modules/update_device_info/system.prop"
...
# Spoof Android ID
echo "[INFO] Changing Android ID to 52c772cb9e3496a2..."
su -c "settings put secure android_id "52c772cb9e3496a2"" || echo "[ERROR] Failed to change Android ID."
