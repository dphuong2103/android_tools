...
class RebootCommand extends Command {
  const RebootCommand() : super(description: "Reboots the device");
}
...
class RemoveProxyCommand extends Command {
  const RemoveProxyCommand() : super(description: "Removes proxy settings");
}
...
class WaitRandomCommand extends Command {
  ...
  const WaitRandomCommand({
    required this.minDelayInSecond,
    required this.maxDelayInSecond,
  }) : super(
         description: "Waits for random duration between min and max seconds",
       );
}

class SetUpCommand extends Command {
  const SetUpCommand() : super(description: "Performs initial device setup");
}
...
class ListBackUpFileCommand extends Command {
  const ListBackUpFileCommand() : super(description: "Lists all backup files");
}
...
class ResetPhoneStateCommand extends Command {
  ...
  const ResetPhoneStateCommand({this.excludeApps})
    : super(
        description: "Remove all installed apps with optional app exclusions",
      );
}
...
class PushAndRunShellScriptCommand extends Command {
  ...
  PushAndRunShellScriptCommand({required this.scriptName, this.parameters})
    : super(
        description: "Pushes and runs shell script with optional parameters",
      );
}
...
class ZipDirectoryCommand extends Command {
  final String zipFilePath;
  final String folderPath;

  const ZipDirectoryCommand({
    required this.zipFilePath,
    required this.folderPath,
  }) : super(description: "Archives a folder to a specified file path");
}
...
class UnzipCommand extends Command{
  ...
  UnzipCommand({
    ...
    description: "Unzips a file to a specified directory",
  );
}

class GetProxyCommand extends Command{
